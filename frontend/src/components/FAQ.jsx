        ...
        <div className="md:max-w-4xl mx-auto">
          ...
          <div className="mb-11 flex flex-wrap -m-1">
            {FAQData.map((item, index) => (
              <div className="w-full p-1" key={`faq-index`}>
                <FAQBox
                  title={item.question}
                  content={item.answer}
...
const FAQBox = ({ defaultOpen, title, content }) => {
  ...
  return (
    <div
      className="pt-2 sm:pt-6 pb-2 px-3 sm:px-8  rounded-3xl bg-neutral-500 border-neutral-100-darker mb-4 relative hover:bg-neutral-500Hover cursor-pointer"
    ...
    >
      <div className="flex flex-col p-2  justify-center items-start">
        ...
        <p
          className={`text-neutral-300 pt-4 transition-all duration-300 overflow-hidden ${
